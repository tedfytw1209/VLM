...
def main():
    ...
    input_path_1 = '/home/vnath/Downloads/Slake/Slake1/test.json'
    output_path = '/home/vnath/Downloads/Slake/Slake1/slake_test_instruct.json'
    # Read input JSON files
    with open(input_path_1, 'r') as input_file1:
        input_data1 = json.load(input_file1)

    # Combine the input data from both files
    combined_input_data = input_data1
